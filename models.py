...
class Friend(models.Model):
    ...
    id_player1 = models.ForeignKey('Player', models.DO_NOTHING, db_column='id_player1')
    id_player2 = models.ForeignKey('Player', models.DO_NOTHING, db_column='id_player2')
...
class RatingHistory(models.Model):
    ...
    id_player = models.ForeignKey(Player, models.DO_NOTHING, db_column='id_player')
    player_give_rating = models.ForeignKey(Player, models.DO_NOTHING, db_column='player_give_rating')
...
class TransferCoin(models.Model):
    ...
    id_player = models.ForeignKey(Player, models.DO_NOTHING, db_column='id_player', blank=True, null=True)
    id_player_transfered = models.ForeignKey(Player, models.DO_NOTHING, db_column='id_player_transfered', blank=True, null=True)
