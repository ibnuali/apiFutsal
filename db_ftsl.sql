...
(37, 'Can add chat', 13, 'add_chat'),
(38, 'Can change chat', 13, 'change_chat'),
(39, 'Can delete chat', 13, 'delete_chat'),
(40, 'Can add city', 14, 'add_city'),
(41, 'Can change city', 14, 'change_city'),
(42, 'Can delete city', 14, 'delete_city'),
(43, 'Can add country', 15, 'add_country'),
(44, 'Can change country', 15, 'change_country'),
(45, 'Can delete country', 15, 'delete_country'),
(46, 'Can add district', 16, 'add_district'),
(47, 'Can change district', 16, 'change_district'),
(48, 'Can delete district', 16, 'delete_district'),
...
(61, 'Can add field location', 21, 'add_fieldlocation'),
(62, 'Can change field location', 21, 'change_fieldlocation'),
(63, 'Can delete field location', 21, 'delete_fieldlocation'),
(64, 'Can add friend', 22, 'add_friend'),
(65, 'Can change friend', 22, 'change_friend'),
(66, 'Can delete friend', 22, 'delete_friend'),
(67, 'Can add genders', 23, 'add_genders'),
(68, 'Can change genders', 23, 'change_genders'),
(69, 'Can delete genders', 23, 'delete_genders'),
(70, 'Can add join party', 24, 'add_joinparty'),
(71, 'Can change join party', 24, 'change_joinparty'),
(72, 'Can delete join party', 24, 'delete_joinparty'),
(73, 'Can add join room', 25, 'add_joinroom'),
(74, 'Can change join room', 25, 'change_joinroom'),
(75, 'Can delete join room', 25, 'delete_joinroom'),
(76, 'Can add level', 26, 'add_level'),
(77, 'Can change level', 26, 'change_level'),
(78, 'Can delete level', 26, 'delete_level'),
(79, 'Can add level history', 27, 'add_levelhistory'),
(80, 'Can change level history', 27, 'change_levelhistory'),
(81, 'Can delete level history', 27, 'delete_levelhistory'),
(82, 'Can add party', 28, 'add_party'),
(83, 'Can change party', 28, 'change_party'),
(84, 'Can delete party', 28, 'delete_party'),
(85, 'Can add player', 29, 'add_player'),
(86, 'Can change player', 29, 'change_player'),
(87, 'Can delete player', 29, 'delete_player'),
(88, 'Can add player position', 30, 'add_playerposition'),
(89, 'Can change player position', 30, 'change_playerposition'),
(90, 'Can delete player position', 30, 'delete_playerposition'),
(91, 'Can add positions', 31, 'add_positions'),
(92, 'Can change positions', 31, 'change_positions'),
(93, 'Can delete positions', 31, 'delete_positions'),
(94, 'Can add province', 32, 'add_province'),
(95, 'Can change province', 32, 'change_province'),
(96, 'Can delete province', 32, 'delete_province'),
(97, 'Can add rating', 33, 'add_rating'),
(98, 'Can change rating', 33, 'change_rating'),
(99, 'Can delete rating', 33, 'delete_rating'),
(100, 'Can add rating history', 34, 'add_ratinghistory'),
(101, 'Can change rating history', 34, 'change_ratinghistory'),
(102, 'Can delete rating history', 34, 'delete_ratinghistory'),
(103, 'Can add required positions', 35, 'add_requiredpositions'),
(104, 'Can change required positions', 35, 'change_requiredpositions'),
(105, 'Can delete required positions', 35, 'delete_requiredpositions'),
...
INSERT INTO `district` (`id_district`, `id_city`, `name_district`) VALUES
...
(1, 'contenttypes', '0001_initial', '2017-02-05 05:22:53.911527'),
(2, 'auth', '0001_initial', '2017-02-05 05:23:00.521221'),
(3, 'admin', '0001_initial', '2017-02-05 05:23:03.286979'),
(4, 'admin', '0002_logentry_remove_auto_add', '2017-02-05 05:23:03.365112'),
(5, 'api', '0001_initial', '2017-02-05 05:23:03.474493'),
(6, 'contenttypes', '0002_remove_content_type_name', '2017-02-05 05:23:04.787052'),
(7, 'auth', '0002_alter_permission_name_max_length', '2017-02-05 05:23:05.630845'),
(8, 'auth', '0003_alter_user_email_max_length', '2017-02-05 05:23:06.662163'),
(9, 'auth', '0004_alter_user_username_opts', '2017-02-05 05:23:06.990285'),
(10, 'auth', '0005_alter_user_last_login_null', '2017-02-05 05:23:07.630941'),
(11, 'auth', '0006_require_contenttypes_0002', '2017-02-05 05:23:07.662212'),
...
INSERT INTO `level` (`id_level`, `score_level`, `score_exp`) VALUES
(1, 1, 0),
(2, 2, 100),
(3, 3, 300),
(4, 4, 600),
...
INSERT INTO `positions` (`id_position`, `position`) VALUES
(1, 'Goalkeeper'),
(2, 'Defender'),
(3, 'Winger'),
(4, 'Pivot');
...
INSERT INTO `province` (`id_province`, `id_country`, `name_province`) VALUES
('11', 1, 'Aceh'),
('12', 1, 'Sumatera Utara'),
('13', 1, 'Sumatera Barat'),
('14', 1, 'Riau'),
...
INSERT INTO `rating` (`id_rating`, `score_rating`) VALUES
(1, 0),
(2, 0.01),
(3, 0.02),
(4, 0.03),
...
CREATE TABLE IF NOT EXISTS `room` (
  ...
  `id_field_location` int(11) DEFAULT NULL,
  ...
  `required_level_min` int(11) DEFAULT NULL,
  `required_level_max` int(11) DEFAULT NULL,
  `required_age_min` int(11) DEFAULT NULL,
  `required_age_max` int(11) DEFAULT NULL,
  `required_slot` int(11) NOT NULL,
...
ALTER TABLE `chat`
  ...
  ADD KEY `FK_chat_friend` (`id_friend`),
  ADD KEY `FK_chat_party` (`id_party`),
  ADD KEY `FK_chat_room` (`id_room`),
  ADD KEY `FK_player_chat_fk` (`id_player`);
...
ALTER TABLE `city`
  ...
  ADD KEY `FK_province_city_fk` (`id_province`);
...
ALTER TABLE `district`
  ...
  ADD KEY `FK_city_distict_fk` (`id_city`);
...
ALTER TABLE `field_location`
  ADD PRIMARY KEY (`id_field_location`),
  ADD KEY `FK_district_field_fk` (`id_district`);

--
-- Indexes for table `field_photos`
--
...
ALTER TABLE `friend`
  ...
  ADD KEY `FK_player_friend_fk1` (`id_player1`),
  ADD KEY `FK_player_friend_fk2` (`id_player2`);
...
--
-- Indexes for table `join_party`
--
ALTER TABLE `join_party`
  ADD PRIMARY KEY (`id_join_party`),
  ADD KEY `FK_party_join_party_fk` (`id_party`),
  ADD KEY `FK_player_join_party_fk` (`id_player`);

--
-- Indexes for table `join_room`
--
ALTER TABLE `join_room`
  ADD PRIMARY KEY (`id_join_room`),
  ADD KEY `FK_player_join_room_fk` (`id_player`),
  ADD KEY `FK_room_join_room_fk` (`id_room`);
...
ALTER TABLE `level_history`
  ADD PRIMARY KEY (`id_level_history`),
  ADD KEY `FK_level_level_history_fk` (`id_level`),
  ADD KEY `FK_player_level_history_fk` (`id_player`);
...
ALTER TABLE `party`
  ...
  ADD KEY `FK_party_master_fk` (`id_player`);
...
ALTER TABLE `player_position`
  ADD PRIMARY KEY (`id_player_position`),
  ADD KEY `FK_player_player_position_fk` (`id_player`),
  ADD KEY `FK_positions_player_position_fk` (`id_position`);
...
ALTER TABLE `province`
  ...
  ADD KEY `FK_country_province_fk` (`id_country`);
...
ALTER TABLE `rating_history`
  ADD PRIMARY KEY (`id_rating_history`),
  ADD KEY `FK_player_rating_history_fk` (`id_player`),
  ADD KEY `FK_rating_rating_history_fk` (`id_rating`);

--
-- Indexes for table `required_positions`
--
ALTER TABLE `required_positions`
  ADD PRIMARY KEY (`id_required_positions`),
  ADD KEY `FK_positions_required_position_fk` (`id_position`),
  ADD KEY `FK_room_required_positions_fk` (`id_room`);
...
ALTER TABLE `room`
  ...
  ADD KEY `FK_distict_room_fk` (`id_field_location`),
  ADD KEY `FK_required_gender_fk` (`required_gender`),
  ADD KEY `FK_room_master_fk` (`id_player`);
...
--
ALTER TABLE `field_location`
  MODIFY `id_field_location` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `join_party`
  MODIFY `id_join_party` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `join_room`
--
ALTER TABLE `join_room`
  MODIFY `id_join_room` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `required_positions`
  MODIFY `id_required_positions` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `chat`
  ADD CONSTRAINT `FK_chat_friend` FOREIGN KEY (`id_friend`) REFERENCES `friend` (`id_friend`),
  ADD CONSTRAINT `FK_chat_party` FOREIGN KEY (`id_party`) REFERENCES `party` (`id_party`),
  ADD CONSTRAINT `FK_chat_room` FOREIGN KEY (`id_room`) REFERENCES `room` (`id_room`),
  ADD CONSTRAINT `FK_player_chat_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`);

--
-- Constraints for table `city`
--
ALTER TABLE `city`
  ADD CONSTRAINT `FK_province_city_fk` FOREIGN KEY (`id_province`) REFERENCES `province` (`id_province`);

--
-- Constraints for table `district`
--
ALTER TABLE `district`
  ADD CONSTRAINT `FK_city_distict_fk` FOREIGN KEY (`id_city`) REFERENCES `city` (`id_city`);
...
--
-- Constraints for table `field_location`
--
ALTER TABLE `field_location`
  ADD CONSTRAINT `FK_district_field_fk` FOREIGN KEY (`id_district`) REFERENCES `district` (`id_district`);

--
-- Constraints for table `field_photos`
--
ALTER TABLE `field_photos`
  ADD CONSTRAINT `FK_field_photos_fk` FOREIGN KEY (`id_field`) REFERENCES `field` (`id_field`);

--
-- Constraints for table `friend`
--
ALTER TABLE `friend`
  ADD CONSTRAINT `FK_player_friend_fk1` FOREIGN KEY (`id_player1`) REFERENCES `player` (`id_player`),
  ADD CONSTRAINT `FK_player_friend_fk2` FOREIGN KEY (`id_player2`) REFERENCES `player` (`id_player`);

--
-- Constraints for table `join_party`
--
ALTER TABLE `join_party`
  ADD CONSTRAINT `FK_party_join_party_fk` FOREIGN KEY (`id_party`) REFERENCES `party` (`id_party`),
  ADD CONSTRAINT `FK_player_join_party_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`);

--
-- Constraints for table `join_room`
--
ALTER TABLE `join_room`
  ADD CONSTRAINT `FK_player_join_room_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`),
  ADD CONSTRAINT `FK_room_join_room_fk` FOREIGN KEY (`id_room`) REFERENCES `room` (`id_room`);

--
-- Constraints for table `level_history`
--
ALTER TABLE `level_history`
  ADD CONSTRAINT `FK_level_level_history_fk` FOREIGN KEY (`id_level`) REFERENCES `level` (`id_level`),
  ADD CONSTRAINT `FK_player_level_history_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`);

--
-- Constraints for table `party`
--
ALTER TABLE `party`
  ADD CONSTRAINT `FK_party_master_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`);

--
-- Constraints for table `player`
--
ALTER TABLE `player`
  ADD CONSTRAINT `FK_distict_player_fk` FOREIGN KEY (`id_district`) REFERENCES `district` (`id_district`),
  ADD CONSTRAINT `FK_genders_player_fk` FOREIGN KEY (`id_gender`) REFERENCES `genders` (`id_gender`);

--
-- Constraints for table `player_position`
--
ALTER TABLE `player_position`
  ADD CONSTRAINT `FK_player_player_position_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`),
  ADD CONSTRAINT `FK_positions_player_position_fk` FOREIGN KEY (`id_position`) REFERENCES `positions` (`id_position`);

--
-- Constraints for table `province`
--
ALTER TABLE `province`
  ADD CONSTRAINT `FK_country_province_fk` FOREIGN KEY (`id_country`) REFERENCES `country` (`id_country`);

--
-- Constraints for table `rating_history`
--
ALTER TABLE `rating_history`
  ADD CONSTRAINT `FK_player_rating_history_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`),
  ADD CONSTRAINT `FK_rating_rating_history_fk` FOREIGN KEY (`id_rating`) REFERENCES `rating` (`id_rating`);

--
-- Constraints for table `required_positions`
--
ALTER TABLE `required_positions`
  ADD CONSTRAINT `FK_positions_required_position_fk` FOREIGN KEY (`id_position`) REFERENCES `positions` (`id_position`),
  ADD CONSTRAINT `FK_room_required_positions_fk` FOREIGN KEY (`id_room`) REFERENCES `room` (`id_room`);

--
-- Constraints for table `room`
--
ALTER TABLE `room`
  ADD CONSTRAINT `FK_distict_room_fk` FOREIGN KEY (`id_field_location`) REFERENCES `field_location` (`id_field_location`),
  ADD CONSTRAINT `FK_required_gender_fk` FOREIGN KEY (`required_gender`) REFERENCES `genders` (`id_gender`),
  ADD CONSTRAINT `FK_room_master_fk` FOREIGN KEY (`id_player`) REFERENCES `player` (`id_player`);
